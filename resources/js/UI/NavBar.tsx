...
function NavBar() {
    ...
    return (
        <motion.nav
            className={`font-montserrat z-100 flex content-center items-center gap-8 overflow-hidden text-white ${
                isSticky
                    ? 'fade-in-down fixed top-0 right-0 w-full justify-end bg-black/90 py-3 pr-60 shadow-lg'
                    : 'absolute top-0 right-0 mt-7 mr-2 lg:mr-60'
            }`}
