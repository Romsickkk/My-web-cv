...
function Skills() {
    ...
    return (
        <div id="skills" className="flex flex-col items-center justify-center bg-[#d6d6d6]">
            <FadeInOnView>
                <AnimatedCard name={t.skills.title} className="animation-delay-250 mt-10" />
            </FadeInOnView>
            <div className="mx-auto mb-20 flex flex-col md:w-[700px]">
                <h2
                    className={`fade-in-up font-montserrat mb-10 h-15 w-80 text-2xl font-bold whitespace-nowrap select-none max-sm:text-center md:pl-5`}
                >
                    {t.skills.subtitle}:
                </h2>
                <div
                ...
                >
                    <FadeInOnView>
                        <div className="grid grid-cols-4 gap-18 max-sm:flex max-sm:flex-col">
                            ...
                            {isMoreSkills && (
                                <>
                                    ...
                                    <div className={`${skillClass} animation-delay-300`}>
                                        <img className="h-15" src="/linux-logo.svg" alt="HTML Logo" />
                    ...
                    <Button
                        text={expanded ? t.skills.buttonClose : t.skills.buttonOpen}
